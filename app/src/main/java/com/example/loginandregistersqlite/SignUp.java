...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        EditText et_password = (EditText) findViewById(R.id.tPassword);
    }
    public void OK(View view)
    {
        ...
        String password = et_ID.getText().toString();
        ...
        else
        {
            ...
            receiveOk =loginDataBaseAdapter.insertEntry(firstName, lastName, userName, password);
